        ...
        <>
            <Row>
                <Col md={6} xs={12}>
                    ...
                    <div>
                        <div>
                            <p> Hi Everyone, I am Nguyen Van Thanh Trong from Da Nang, VietNam.</p>

                            <p> Information Technology undergraduate with hands-on experience in full-stack web development </p>

                            <p>Proficient in backend frameworks such as Django and Spring, and frontend technologies including React.js and React Native </p>

                            <p>Familiar with software architectural patterns like MVC, Restful APIs, and the principles of both stateless and stateful systems</p>
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div className="experience-container">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="company">Open University</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <Row>
                ...
                <Col md={6} xs={12} className="d-flex flex-column align-items-center justify-content-center">
                    ...
                    />
                    <a href="mailto:vthanhtrongng@gmail.com"><h4 className="text-center">Contact me</h4></a>
                </Col>
            </Row>
